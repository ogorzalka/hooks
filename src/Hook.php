...
namespace DigitalBit\Hooks;

use Closure;
use DigitalBit\Hooks\Contracts\Hook as HookContract;
use DigitalBit\Hooks\Support\ArgumentCountCalculator;
use DigitalBit\Hooks\Support\ClassCallbackFormatter;
